...
var sprite;
var platform1,platform2,platform3,platform4,platform5,platform6,p2,p2_image;
var score=0;


function preload(){
  jack_image=loadImage("images/jack2.png");
  p2_image = loadImage("images/platformsssss.png");
...
function setup() {
 ...
 p2 = createSprite(250,550,10,5);
 p2.addImage("p2",p2_image);
 p2.scale=1;
 p2.width=200;
